...
- [SQL - TutorialsPoint](https://www.tutorialspoint.com/sql/index.htm): Aprender SQL y bases de datos puede parecer complicado pero es sencillo una vez que se tienen nociones básicas de variables, tipos de datos, estructuras de datos y algoritmos. La alternativa a aprender SQL es aprender NOSQL.
- [Aprender GIT](https://www.freecodecamp.org/espanol/news/aprende-git-y-github-curso-desde-cero/): Git permite a los desarrolladores trabajar en el mismo proyecto al mismo tiempo y colaborar de manera eficiente. Cada cambio en el código fuente se registra como un "commit", que incluye una descripción del cambio y el autor del mismo. Git también permite a los desarrolladores crear ramas o "branches" del proyecto para trabajar en nuevas características o solucionar problemas sin afectar la rama principal.
